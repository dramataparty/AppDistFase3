...
import requests
import json
r = requests.get('http://localhost:5000/aluno/25') #onde colocamos o sql pra o projeto?
print (r.status_code)
print (r.content.decode())
print (r.headers)
print ('***')
dados = {'numero': 123, 'nome': 'Carabino Tiro Certo', 'idade': 18} # mudar para algo apropriado
r = requests.put('http://localhost:5000/aluno', json = dados)
print (r.status_code)
print (r.content.decode())
print (r.headers)
print ('***')
notas = {'numero_aluno': 123, 'ano': '1988/1989', 'cadeira': 'AD', 'nota': 20} # mudar para algo apropriado
